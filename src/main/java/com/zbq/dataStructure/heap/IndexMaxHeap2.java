 ...
 *
 */
public class IndexMaxHeap2<T extends Comparable> {
    ...
    public IndexMaxHeap2(Integer capacity) {
...
//            }
    ...
    private void shiftUp(int k) {
        while (k > 1 && data.get(indexes.get(k/2)).compareTo(data.get(indexes.get(k))) < 0) {
            ...
            reverse.set(indexes.get(k/2),k/2);
    ...
    public static void main(String[] args) {
        ...
        IndexMaxHeap2<Integer> maxHeap = new IndexMaxHeap2<>(100);
